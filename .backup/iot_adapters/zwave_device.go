...
func NewZWaveDevice(info *iot.DeviceInfo, adapter *ZWaveAdapter) *ZWaveDevice {
	return &ZWaveDevice{
...
func (d *ZWaveDevice) Subscribe(ctx context.Context, events []string, handler iot.DeviceEventHandler) error {
...
func (d *ZWaveDevice) GetCapabilities() []iot.DeviceCapability {
...
func (d *ZWaveDevice) GetInfo() *iot.DeviceInfo {
	return d.info
}
