...
// ZigbeeDevice represents a Zigbee device from Zigbee2MQTT.
...
func (c *ZigbeeMQTTClient) GetDevices(ctx context.Context) ([]*ZigbeeDevice, error) {
	...
	responseChan := make(chan []*ZigbeeDevice, 1)
