...
func NewThreadDevice(info *DeviceInfo, adapter *ThreadAdapter) *ThreadDevice {
	return &ThreadDevice{
...
func (d *ThreadDevice) Subscribe(ctx context.Context, events []string, handler DeviceEventHandler) error {
...
func (d *ThreadDevice) GetCapabilities() []DeviceCapability {
...
func (d *ThreadDevice) GetInfo() *DeviceInfo {
	return &DeviceInfo{
		ID:           d.ID(),
		Name:         d.Name(),
		Type:         d.Type(),
