...
func NewNearLinkDevice(info *DeviceInfo, adapter *NearLinkAdapter) *NearLinkDevice {
...
func (d *NearLinkDevice) Subscribe(ctx context.Context, events []string, handler DeviceEventHandler) error {
...
func (d *NearLinkDevice) GetCapabilities() []DeviceCapability {
...
func (d *NearLinkDevice) GetInfo() *DeviceInfo {
	return d.info
}
